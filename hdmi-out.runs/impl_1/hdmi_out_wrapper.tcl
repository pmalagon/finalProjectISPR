...
set rc [catch {
  ...
  add_files -quiet C:/Users/Ilde/Desktop/Zybo-hdmi-out/proj/hdmi-out.runs/synth_1/hdmi_out_wrapper.dcp
  ...
  set_param project.isImplRun true
  link_design -top hdmi_out_wrapper -part xc7z010clg400-1
  set_param project.isImplRun false
  write_hwdef -force -file hdmi_out_wrapper.hwdef
...
set rc [catch {
  ...
  write_bitstream -force hdmi_out_wrapper.bit 
  ...
  catch {file copy -force debug_nets.ltx hdmi_out_wrapper.ltx}
