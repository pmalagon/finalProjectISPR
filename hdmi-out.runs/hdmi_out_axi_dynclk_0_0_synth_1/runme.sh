...
HD_PWD='C:/Users/Ilde/Desktop/Zybo-hdmi-out/proj/hdmi-out.runs/hdmi_out_axi_dynclk_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_out_axi_dynclk_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_out_axi_dynclk_0_0.tcl
